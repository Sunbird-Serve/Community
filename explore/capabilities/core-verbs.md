...
| **Verb** | **Action**    | **MVP Implemented?** | **Details**                    |
| -------- | ------------- | -------------------- | ------------------------------ |
| REGISTER | Agency        | ✅ Yes                | Implemented - release\_6.1.0.0 |
| ASSIGN   | vCoordinators | ✅ Yes                | Implemented - release\_6.1.0.0 |
| REVIEW   | Ratings       | ❌ No                 |                                |
